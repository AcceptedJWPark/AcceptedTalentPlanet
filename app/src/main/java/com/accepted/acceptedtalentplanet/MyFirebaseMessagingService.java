    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getData().size() > 0) {
            ...
            if (remoteMessage.getData().get("type").equals("dupLogin")) {
                ...
                Intent i = new Intent(mContext, com.accepted.acceptedtalentplanet.LoadingLogin.Login.MainActivity.class);
        ...
        switch (type) {
            ...
            case "QNA":
                if (answerPushGrant) {
                    ...
                    intent1 = new Intent(this, com.accepted.acceptedtalentplanet.CustomerService.Question.QuestionList.MainActivity.class);
            ...
            case "Claim":
                if (answerPushGrant) {
                    ...
                    intent1 = new Intent(this, com.accepted.acceptedtalentplanet.CustomerService.Claim.ClaimList.MainActivity.class);
                    intent1.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            ...
            case "Interest": {
                if(conditionPushGrant) {
                    ...
                    if (talentType == 1) {
                        ...
                        intent1 = new Intent(this, com.accepted.acceptedtalentplanet.InterestingList.MainActivity.class);
            ...
            case "InterestingMatching": {
                ...
                if(conditionPushGrant) {
                    ...
                    intent1 = new Intent(this, com.accepted.acceptedtalentplanet.TalentCondition.MainActivity.class);
                    if (talentType == 2) {
            ...
            case "InterestingCancel":
                {
                    ...
                    if(conditionPushGrant) {
                        ...
                        intent1 = new Intent(this, com.accepted.acceptedtalentplanet.SharingList.MainActivity.class);
