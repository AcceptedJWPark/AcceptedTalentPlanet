package com.accepted.acceptedtalentplanet.TalentResister.Location;
                ...
                ProgressorCancelPopup.setMessage("선택한 위치가 \"" + marker.getSnippet() + "\"가 맞습니까?")
                        .setPositiveButton("확인", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Intent i = new Intent(mContext, com.accepted.acceptedtalentplanet.TalentResister.Level.MainActivity.class);
