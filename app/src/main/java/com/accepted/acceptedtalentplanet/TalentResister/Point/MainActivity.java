package com.accepted.acceptedtalentplanet.TalentResister.Point;
        ...
        StringRequest postJsonRequest = new StringRequest(Request.Method.POST, SaveSharedPreference.getServerIp() + "TalentRegist/goRegist.do", new Response.Listener<String>(){
            ...
            public void onResponse(String response){
                try {
                    ...
                    Intent intent = new Intent(getBaseContext(), com.accepted.acceptedtalentplanet.TalentResister.MainActivity.class);
