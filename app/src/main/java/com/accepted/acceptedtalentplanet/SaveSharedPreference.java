...
public class SaveSharedPreference{
    ...
    static final String SERVER_IP2 = "https://172.30.1.1:8443/Accepted/";
...
//        ((TextView) ((Activity)context).findViewById(R.id.SlidingMenu_TalentSearching)).setOnClickListener(listener);
    ...
    public static void DrawerLayout_Open(View view, final Context mContext, DrawerLayout drawerLayout, View drawerView) {
        ...
        switch (view.getId())
        {
            ...
            {
                i = new Intent(mContext, com.accepted.acceptedtalentplanet.Alarm.MainActivity.class);
            ...
            case R.id.SlidingMenu_Profile : {
                i = new Intent(mContext, com.accepted.acceptedtalentplanet.MyProfile.MainActivity.class);
                mContext.startActivity(i);
                break;
            }

            case R.id.SlidingMenu_MyTalentResister : {
                i = new Intent(mContext, com.accepted.acceptedtalentplanet.TalentResister.MainActivity.class);
                mContext.startActivity(i);
                break;
            }
            ...
            case R.id.SlidingMenu_TSharing : {
                i = new Intent(mContext, com.accepted.acceptedtalentplanet.TalentSharing.MainActivity.class);
...
//            }
            ...
            case R.id.SlidingMenu_SharingList : {
                i = new Intent(mContext, com.accepted.acceptedtalentplanet.SharingList.MainActivity.class);
                mContext.startActivity(i);
                break;
            }
            ...
            case R.id.SlidingMenu_FriendList : {
                i = new Intent(mContext, com.accepted.acceptedtalentplanet.FriendList.MainActivity.class);
                mContext.startActivity(i);
                break;
            }

            case R.id.SlidingMenu_ServiceCenter : {
                i = new Intent(mContext, com.accepted.acceptedtalentplanet.CustomerService.MainActivity.class);
                mContext.startActivity(i);
                break;
            }

            case R.id.SlidingMenu_System : {
                i = new Intent(mContext, com.accepted.acceptedtalentplanet.System.MainActivity.class);
                mContext.startActivity(i);
                break;
            }
            ...
            case R.id.SlidingMenu_LogOut : {
                ...
                i = new Intent(mContext, com.accepted.acceptedtalentplanet.LoadingLogin.Login.MainActivity.class);
