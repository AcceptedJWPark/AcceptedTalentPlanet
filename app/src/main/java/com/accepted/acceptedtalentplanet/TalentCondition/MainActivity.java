package com.accepted.acceptedtalentplanet.TalentCondition;
            ...
            switch (Code) {
                case 1: {
                    ...
                    btn_Left.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Intent intent = new Intent(mContext, com.accepted.acceptedtalentplanet.InterestingList.MainActivity.class);
                            intent.putExtra("TalentFlag", "Give");
                            startActivity(intent);
                        }
                    });
                    btn_Right.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Intent intent = new Intent(mContext, com.accepted.acceptedtalentplanet.TalentSharing.MainActivity.class);
                ...
                try {
                    ...
                    if(obj.getString("result").equals("success")){
                        ...
                        if(((String) tv_TalentType.getText()).equals("관심재능 : "))
                        {
                            ...
                            Intent i = new Intent(MainActivity.this, com.accepted.acceptedtalentplanet.TalentSharing.MainActivity.class);
