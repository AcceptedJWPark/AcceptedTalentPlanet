...
public class Messanger_Chatting_Item {
    ...
    public Messanger_Chatting_Item(int messsanger_Pic, String messanger_Content, String messanger_Date, int message_Type, boolean picture_Type, boolean time_Changed, boolean date_Changed) {
