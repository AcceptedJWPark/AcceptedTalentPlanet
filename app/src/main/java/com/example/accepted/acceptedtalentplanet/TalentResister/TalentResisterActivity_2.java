...
public class TalentResisterActivity_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.talentresister_resist2);
        //ToolBar 적용하기
        slidingMenuDL = (DrawerLayout) findViewById(R.id.TalentResister2_listboxDL);
        drawerView = (View) findViewById(R.id.TalentCondition_container2);
