...
public class Home_BestTalent_ListView_Adapter extends BaseAdapter{

    Context context;
    ArrayList<Home_BestTalent_ListItem> list_ArrayList;
    ...
    public Home_BestTalent_ListView_Adapter(Context context, ArrayList<Home_BestTalent_ListItem> list_ArrayList) {
        this.context = context;
        this.list_ArrayList = list_ArrayList;
    }

    public void setItem(ArrayList<Home_BestTalent_ListItem> list_ArrayList){
        this.list_ArrayList = list_ArrayList;
    }
