...
public class Messanger_Chatting extends AppCompatActivity {

    Context mContext;
    ListView messanger_Chatting_LV;
    Messanger_Chatting_Adapter messanger_chatting_adapter;
    ArrayList<Messanger_Chatting_Item> messanger_chatting_ArrayList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        messanger_chatting_adapter = new Messanger_Chatting_Adapter(messanger_chatting_ArrayList, mContext);
...
//                }
                ...
                if (messanger_chatting_ArrayList.size() == 0) {
                    messanger_chatting_ArrayList.add(new Messanger_Chatting_Item(R.drawable.testpicture, chattingEditTxt, "1", 1, false, true, false));
                    ...
                    messanger_chatting_ArrayList.add(new Messanger_Chatting_Item(R.drawable.testpicture, chattingEditTxt, "1", message_Type, picture_Type, time_Changed, date_Changed));
                    messanger_Chatting_LV.setAdapter(messanger_chatting_adapter);
                    messanger_chatting_adapter.notifyDataSetChanged();
                messanger_Chatting_LV.setSelection(messanger_chatting_adapter.getCount()-1);
                Messanger_Chatting_EditTxt.setText("");
...
//                    int prevPosition = 0;
//                    if (messanger_chatting_ArrayList.size() == 0) {
//                        messanger_chatting_ArrayList.add(new Messanger_Chatting_Item(R.drawable.testpicture, chattingEditTxt, "1", 2, true, true, false));
//                        messanger_Chatting_LV.setAdapter(messanger_chatting_adapter);
//                        messanger_Chatting_LV.setSelection(messanger_chatting_adapter.getCount() - 1);
//                        return;
//                    } else if (messanger_chatting_ArrayList.size() > 0) {
