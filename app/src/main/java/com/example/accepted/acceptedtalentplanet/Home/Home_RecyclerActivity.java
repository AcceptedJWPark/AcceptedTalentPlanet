...
public class Home_RecyclerActivity extends AppCompatActivity {

    Context mContext;
    ArrayList<Home_Item> mItems;
    ...
    class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
        ...
        private ArrayList<Home_Item> mItems;

        public MyAdapter(ArrayList<Home_Item> items) {
            mItems = items;
        }
