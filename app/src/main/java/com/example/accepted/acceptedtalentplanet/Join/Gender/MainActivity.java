package com.example.accepted.acceptedtalentplanet.Join.Gender;
...
public class MainActivity extends  AppCompatActivity {
    ...
    public void goNext(View v){
        ...
        if (genderTxt.equals("성별 선택"))
        {
            ...
            Intent intent = new Intent(this, com.example.accepted.acceptedtalentplanet.Join.Birth.MainActivity.class);
