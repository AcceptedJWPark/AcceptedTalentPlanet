...
public class TalentResisterActivity_4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.talentresister_resist4);

        //ToolBar 적용하기
        slidingMenuDL = (DrawerLayout) findViewById(R.id.TalentCondition4_listboxDL);
        drawerView = (View) findViewById(R.id.TalentCondition_container4);
