...
public class Messanger_Chatting_Adapter extends BaseAdapter {
    ...
    public Messanger_Chatting_Adapter(ArrayList<Messanger_Chatting_Item> messanger_Chatting_Arraylist, Context mContext, Bitmap picture) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(messanger_Chatting_Arraylist.get(position).getMessage_Type()==2)
        {
            if(picture != null){
                ...
                holder.Messanger_Chatting_Picture.setBackgroundResource(messanger_Chatting_Arraylist.get(position).getMesssanger_Pic());
            }
        ...
        {
            String dateStr = messanger_Chatting_Arraylist.get(position).getMessanger_Date();
    ...
    public void refreshAdapter(ArrayList<Messanger_Chatting_Item> items){
