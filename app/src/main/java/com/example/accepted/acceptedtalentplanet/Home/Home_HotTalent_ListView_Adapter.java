...
public class Home_HotTalent_ListView_Adapter extends BaseAdapter{

        Context context;
        ArrayList<Home_HotTalent_ListItem> list_ArrayList;
    TextView listView_rank;
    TextView listView_talent;
    TextView listView_category;
    TextView listView_number;

    public Home_HotTalent_ListView_Adapter(Context context, ArrayList<Home_HotTalent_ListItem> list_ArrayList) {
