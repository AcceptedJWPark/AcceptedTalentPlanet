        ...
        StringRequest postJsonRequest = new StringRequest(Request.Method.POST, SaveSharedPreference.getServerIp() + "TalentSharing/getProfileInfo.do", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    ((TextView)findViewById(R.id.location2_InterestingPopup)).setText(obj.getString("LOCATION2"));
                    ((TextView)findViewById(R.id.location3_InterestingPopup)).setText(obj.getString("LOCATION3"));
